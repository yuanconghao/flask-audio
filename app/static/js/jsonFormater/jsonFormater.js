function JsonFormatter(opt) {
    this.options = this.extend({}, {
        ...
        singleTab: "  ",
        quoteKeys: true,
        imgCollapsed: "/static/js/jsonFormater/images/Collapsed.gif",
        imgExpanded: "/static/js/jsonFormater/images/Expanded.gif",
        isCollapsible: true
    }, opt);
...
JsonFormatter.prototype = {
    ...
    doFormat: function(json) {
        ...
        try {
            ...
            document.getElementById(this.options.dom).innerHTML = "<pre class='jf-CodeContainer'>" + html + "</pre>";
            this.isFormated = true;
            this.bindEvent();
        } catch (e) {
            alert("JSON数据格式不正确:\n" + e.message);
            document.getElementById(this.options.dom).innerHTML = ''
            this.isFormated = false;
        }
    },
    extend: function(out) {
